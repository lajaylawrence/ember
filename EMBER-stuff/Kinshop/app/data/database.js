// temprarily holds all the datta which is imported into the controller if anothe rpage
//export it so it can be imported in other controllers
...
export const products = [{
    ...
    "colors": [{
        "color": "red",
        "image": "beats-solo-red.png"
      },
      {
        "color": "black",
        "image": "beats-solo-black.png"
      }
    ]
  },
  {
    "id": "soccer-ball",
    "name": "Brand Soccer Ball",
    "description": "With up to 40 hours of battery life, Beats Solo Wireless is your perfect everyday headphone",
    "price": {
      "original": 199.95,
      "current": 99.98
